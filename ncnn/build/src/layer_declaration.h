...
namespace ncnn {
class MatMul_final : virtual public MatMul, virtual public MatMul_arm
{
public:
    virtual int create_pipeline(const Option& opt) {
        { int ret = MatMul::create_pipeline(opt); if (ret) return ret; }
        { int ret = MatMul_arm::create_pipeline(opt); if (ret) return ret; }
        return 0;
    }
    virtual int destroy_pipeline(const Option& opt) {
        { int ret = MatMul_arm::destroy_pipeline(opt); if (ret) return ret; }
