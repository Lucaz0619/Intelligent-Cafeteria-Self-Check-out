...
<<<<<<< HEAD
examples/scrfd: /usr/local/lib/aarch64-linux-gnu/libopencv_highgui.so.4.7.0
examples/scrfd: /usr/local/lib/aarch64-linux-gnu/libopencv_videoio.so.4.7.0
examples/scrfd: /usr/lib/gcc/aarch64-linux-gnu/10/libgomp.so
examples/scrfd: /usr/lib/aarch64-linux-gnu/libpthread.so
examples/scrfd: /usr/local/lib/aarch64-linux-gnu/libopencv_imgcodecs.so.4.7.0
examples/scrfd: /usr/local/lib/aarch64-linux-gnu/libopencv_imgproc.so.4.7.0
examples/scrfd: /usr/local/lib/aarch64-linux-gnu/libopencv_core.so.4.7.0
=======
